...
from app.api.v1.schemas.slo import SloCreate, SloOut, SloTranslationOut
...
async def get_all_slos(db: AsyncSession = Depends(get_db)):
    return await get_all_slos_service(db)

# GET SLO by specialty_code
@router.get("/{specialty_code}", response_model=None)
